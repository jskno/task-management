...
@Component
public class ProjectServiceOrdered implements BeanPostProcessor, Ordered {

    private static Logger LOGGER = LoggerFactory.getLogger(ProjectServiceOrdered.class);
