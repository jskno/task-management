...
public class ProjectRepositoryStatic implements BeanPostProcessor, Ordered {

    private static Logger LOGGER = LoggerFactory.getLogger(ProjectRepositoryStatic.class);
