...
@Component
public class ProjectRepositoryOrdered2 implements BeanPostProcessor, Ordered {

    private static Logger LOGGER = LoggerFactory.getLogger(ProjectRepositoryOrdered2.class);
